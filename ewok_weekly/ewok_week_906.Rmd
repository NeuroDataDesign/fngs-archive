...
### E Step
For the E step, we must compute the expected log likelihood $\Gamma = E[log P(\textbf{X},\textbf{Y}|\textbf{Y})]$, which depends on the following three expectations: $E[x_t|\textbf{Y}]$, $E[x_tx_t^T|\textbf{Y}]$, and $E[x_tx_{t-1}^T|\textbf{Y}]$.
